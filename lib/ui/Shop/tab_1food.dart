...
class ShopFood extends StatefulWidget {
  ...
  ShopFood({this.categoryId, this.getShopStore});
  @override
  _ShopCardState createState() => _ShopCardState();
}

class _ShopCardState extends State<ShopFood> {
  bool singleLineCard = false;
  @override
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      if (!widget.getShopStore.isFoodListLoaded)
  ...
  Widget build(BuildContext context) {
    return Observer(
        builder: (_) => widget.getShopStore.isFoodListLoaded
            ? Column(
