...
class _ShopContactScreenState extends State<ShopContactScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: colorMain,title: Text('SHOP CONTACT DETAILS'),
        elevation: 0.0,
        centerTitle: true,
  ...
  shopType() {
    return Container(
      height: 200,
      width: 200,
      child:Image.asset('assets/goldicon.png') ,
    );
  }
